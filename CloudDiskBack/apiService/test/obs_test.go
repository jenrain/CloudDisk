...
func TestUploadFileToOBS(t *testing.T) {
	...
	input.SourceFile = "../download/default.png"
...
func TestObjectExist(t *testing.T) {
	...
	input.Bucket = "data-storage95"
	input.Key = "cloud-disk/defaul.png"
...
//	path := tools.GetFilePath("99c51cde-46ee-45d7-8a07-a61375e2a364", ".mp3")
//	fmt.Println("文件地址：", path)
//}
